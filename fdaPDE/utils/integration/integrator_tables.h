...
template <> struct IntegratorTable<3, 27, GaussLegendre> {
    enum {
        input_dim = 3,  // input space dimension of integrand field
        num_nodes = 27  // number of qudrature nodes
    };
    // position of nodes (in barycentric coordinates)
    std::array<SVector<3>, 27> nodes = {
       SVector<3>(-0.774596669241483, -0.774596669241483, -0.774596669241483),
       SVector<3>(-0.774596669241483, -0.774596669241483,                  0),
       SVector<3>(-0.774596669241483, -0.774596669241483,  0.774596669241483),
       SVector<3>(-0.774596669241483,                  0, -0.774596669241483),
       SVector<3>(-0.774596669241483,                  0,                  0),
       SVector<3>(-0.774596669241483,                  0,  0.774596669241483),
       SVector<3>(-0.774596669241483,  0.774596669241483, -0.774596669241483),
       SVector<3>(-0.774596669241483,  0.774596669241483,                  0),
       SVector<3>(-0.774596669241483,  0.774596669241483,  0.774596669241483),
       SVector<3>(                 0, -0.774596669241483, -0.774596669241483),
       SVector<3>(                 0, -0.774596669241483,                  0),
       SVector<3>(                 0, -0.774596669241483,  0.774596669241483),
       SVector<3>(                 0,                  0, -0.774596669241483),
       SVector<3>(                 0,                  0,                  0),
       SVector<3>(                 0,                  0,  0.774596669241483),
       SVector<3>(                 0,  0.774596669241483, -0.774596669241483),
       SVector<3>(                 0,  0.774596669241483,                  0),
    ...
    std::array<double, 27> weights = {
        0.171467764060357, 0.274348422496571, 0.171467764060357, 0.274348422496571,
