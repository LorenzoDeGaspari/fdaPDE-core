...
#ifndef __IGA_LINEAR_ELLIPTIC_SOLVER_H__
#define __IGA_LINEAR_ELLIPTIC_SOLVER_H__

#include <exception>

#include "../../utils/symbols.h"
#include "iga_solver_base.h"

namespace fdapde {
namespace core {
  
template <typename D, typename E, typename F, typename... Ts>
struct IGALinearEllipticSolver : public IGASolverBase<D, E, F, Ts...> {
    ...
    template <typename PDE> void solve(const PDE& pde) {
        ...
        //typedef Eigen::FullPivLU<SpMatrix<double>> SystemSolverType;
...
#endif   // __IGA_LINEAR_ELLIPTIC_SOLVER_H__
