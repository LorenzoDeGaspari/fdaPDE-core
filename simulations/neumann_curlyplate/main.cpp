...
int main(){
    ...
    testData test_ref0("Refinement 0", 33, "data/curlyplate_kx_ref0.mtx", "data/curlyplate_ky_ref0.mtx",
                       ...
                       "data/curlyplate_cpy_ref0.mtx", "data/curlyplate_cpz_ref0.mtx", "data/curlyplate_neumann_geopde_sol_33.mtx");
    ...
    testData test_ref1("Refinement 1", 56, "data/curlyplate_kx_ref1.mtx", "data/curlyplate_ky_ref1.mtx",
                       ...
                       "data/curlyplate_cpy_ref1.mtx", "data/curlyplate_cpz_ref1.mtx", "data/curlyplate_neumann_geopde_sol_56.mtx");
    ...
    testData test_ref2("Refinement 2", 108, "data/curlyplate_kx_ref2.mtx", "data/curlyplate_ky_ref2.mtx",
                       ...
                       "data/curlyplate_cpy_ref2.mtx", "data/curlyplate_cpz_ref2.mtx", "data/curlyplate_neumann_geopde_sol_108.mtx");
    ...
    testData test_ref3("Refinement 3", 240, "data/curlyplate_kx_ref3.mtx", "data/curlyplate_ky_ref3.mtx",
                       ...
                       "data/curlyplate_cpy_ref3.mtx", "data/curlyplate_cpz_ref3.mtx", "data/curlyplate_neumann_geopde_sol_240.mtx");
    ...
    post_processing(all_tests, "data/curlyplate_neumann_geopde_times.mtx");
    return 0;
}
...
void solve_problem(testData & test){
    ...
    DMatrix<double, Eigen::RowMajor> gamma_data;
    gamma_data.resize(itg.num_nodes() * mesh.n_elements(), 1);
    for (std::size_t i = 0; i < qq.rows(); ++i) {
        auto tmp = mesh.parametrization()(qq.row(i));
        gamma_data(i) = tmp(0);
    }
    fdapde::core::ScalarDataWrapper<2> gamma(gamma_data);
    fdapde::core::Reaction <fdapde::core::IGA, decltype(gamma)> R(gamma);


    std::cout << "DONE!\n";
    std::cout << "Creating forcing term object...\n";
    // wrap forcing term in a scalar field
    auto f = [] (const SVector<3> & x) -> double { return std::sin(M_PI * x[2]);};
    fdapde::core::ScalarField<3> ff;
    ff = f;
    std::cout << "DONE!\n";
    std::cout << "Creating PDE object...\n";
    // create a pde object
    fdapde::core::PDE<decltype(mesh),decltype(K+R), decltype(ff), fdapde::core::IGA, fdapde::core::iga_order<2>> pde_r0(mesh,K+R,ff);
    std::cout << "DONE!\n";
